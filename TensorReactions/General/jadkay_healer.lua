	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				mpType = 1,
				mpValue = 0,
				name = "Check HP 3 members <= 65 Range <= 15",
				partyHpType = 1,
				partyHpValue = 0,
				partyMpType = 1,
				partyMpValue = 0,
			...
			
			{
				...
				mpType = 1,
				mpValue = 0,
				name = "Check HP Members <= 65 Range <= 30",
				partyHpType = 1,
				partyHpValue = 0,
				partyMpType = 1,
				partyMpValue = 0,
	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return ((Player.level >= 62) and (Player.level <= 80))",
				conditionType = 1,
				conditions = 
				{
				},
